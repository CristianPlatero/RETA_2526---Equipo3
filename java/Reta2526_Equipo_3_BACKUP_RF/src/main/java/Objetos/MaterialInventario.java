...
public class MaterialInventario {
    ...
    public MaterialInventario(String nombre, String descripcion, String estado, String cantidad, String id_ubi,  String fecha_alta, String observaciones) throws NombreInvalidoException, DescripcionInvalidaException, CantidadInvalidaException, EstadoInvalidoException, IdInvalidoException, FechaInvalidaException {
        setNombre(nombre);
        setDescripcion(descripcion);
        setEstado(estado);
        setCantidad(cantidad);
