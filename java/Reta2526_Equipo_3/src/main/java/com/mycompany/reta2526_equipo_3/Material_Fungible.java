...
public class Material_Fungible extends MaterialInventario{
    ...
    public Material_Fungible(String id_inv, String nombre, String descripcion, String estado, String cantidad, String id_estacion, String id_armario, String id_balda, String fecha_alta, String observaciones) throws IdInvalidoException {
